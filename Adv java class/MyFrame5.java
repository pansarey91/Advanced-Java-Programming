...
class MyFrame5 extends JFrame implements ItemListener,ActionListener
{
    ...
    MyFrame5()
    {
        super("Working on Duplication Entries with String Split");        
        ...
        {   
			...
			try
				...
				if(rb_roll.isSelected())
                        ...
                        while(rs.next())
						l1.addItem(rs.getString(1)+") "+rs.getString(2));
					}
	...
	public void itemStateChanged(ItemEvent e)
	{
		if(e.getSource()==l1)
		{
			try
			{
				String arr[] = l1.getSelectedItem().split("\\)");
				sql = "select * from mytable where roll="+ arr[0];
