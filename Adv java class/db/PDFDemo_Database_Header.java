/*
javac -cp ".;c:\*" PDFDemo_Database_Header.java
java -cp ".;c:\*" PDFDemo_Database_Header
...
{
    public static void main(String[] args) throws SQLException, DigestException, IOException
    {
        /** The resulting PDF file. */
        String RESULT = "D:\\Test.pdf";
