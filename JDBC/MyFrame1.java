...
class MyFrame1 extends JFrame implements ActionListener
{
    ...
    public void actionPerformed(ActionEvent e)
    {
        try
        {
            ...
            if(e.getSource() == add)
            {
                sql = "insert into student values(" +troll.getText()+ ",'"
            ...
            if(e.getSource() == del)
            {
                sql = "delete from student where rollno ="+troll.getText();
                prstm = cn.prepareStatement(sql);
                prstm.execute() ;
                prstm.close();
            ...
            if(e.getSource() ==updt)
            {
                sql = "update student set name='" +tnm.getText()+"', age="
				+tage.getText()+" where rollno = "+troll.getText();
                prstm = cn.prepareStatement(sql);
                prstm.execute() ;
                prstm.close();
